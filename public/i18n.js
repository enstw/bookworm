...
const BW_STRINGS = {
  zh: {
    ...
    "admin.verified": "✓ 已驗證",
    "admin.badToken": "✗ 密鑰無效",
    "admin.file": "書檔（.txt 或 .zip 內含一個大 .txt）",
    "admin.bookTitle": "書名",
    ...
    "admin.badSlugChars": "代號只能用小寫英數、中日文字與連字號",
    "admin.idIs": (id) => `書號 ${id}`,
  ...
  en: {
    ...
    "admin.file": "Book file (.txt, or a .zip holding one big .txt)",
    ...
    "admin.badSlugChars": "A slug takes lowercase letters, digits, CJK and hyphens",
